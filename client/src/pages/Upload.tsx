        ...
        {analysis && (
          <div className="space-y-4">
            ...
            <div className="text-center text-[9px] text-slate-700 py-4">
              Generated by IkigaiTradeOS Portfolio Intelligence{analysis._meta?.analyzedAt ? ` at ${new Date(analysis._meta.analyzedAt).toLocaleTimeString()}` : ""}
